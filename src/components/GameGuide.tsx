...
const slides=[
  ...
  {title:'3. 학생 게임 시작',body:'학생은 처음 한 번 자신의 이름을 입력하고 확인합니다. 이후 한 학생이 ‘게임 만들기’로 6자리 숫자 코드를 만들고, 다른 학생이 ‘게임 참가’에서 코드 입력 또는 QR 스캔으로 연결합니다.'},
  {title:'4. 게임 진행',body:'양쪽 READY 후 선 플레이어가 먼저 숫자 타일을 냅니다. 후 플레이어에게는 실제 숫자가 아닌 BLACK/WHITE 색만 공개됩니다. 후 플레이어가 타일을 내면 승패가 결정됩니다.'},
