...
const slides=[
  ...
  {kind:'class',title:'학급에서는 이렇게 운영해요',body:'교사는 교사 게임 운영 페이지를 열고 학생 접속 QR·링크, 타이머, 교사 코드를 안내합니다. 학생 두 명이 게임 유형과 난이도를 의논한 뒤 한 명이 방을 만들고 다른 학생이 QR 또는 4자리 코드로 참가합니다. 한 경기가 끝나면 다른 친구와 계속 경기하고, 수업 종료 후 교사 코드로 전적을 제출합니다.'},
